...
A Quarkus application that uses AI to automatically classify and triage customer support tickets for MediFlow, a medical appointment scheduling application. The service classifies incoming requests, assigns urgency scores, and finds similar historical tickets.
...
2. **AI Classification**: Calls OpenAI GPT-4o-mini with system prompt describing MediFlow and classification rules
