...
This document lists the primary HTTP endpoints exposed by the MediFlow Ticketing System, with **`curl` examples** and **example responses**.
...
```json
{
  "content": "Dear {{userName}},\n\nThank you for contacting MediFlow support...\n"
}
```
