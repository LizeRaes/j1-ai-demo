...
import com.medicalappointment.ticketing.mapper.EventMapper;
import com.medicalappointment.ticketing.persistence.EventLogRepository;
...
public class EventService {
    ...
    public List<com.medicalappointment.ticketing.dto.EventDto> getRecentEvents(OffsetDateTime since, int limit) {
